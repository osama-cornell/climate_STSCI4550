...
plot_interpolations(df = average_df,col1 = average_df$AVERAGE, type = 3,
                    Big_Title = "Average Temperature in March 2024",
...
plot_interpolations(df = preds, col1 = preds$AVERAGE, 
                  Big_Title = "Average Temperature in March 2024 Interpolations",
                    Title = "Temperature (Celsius)")
```
```{r}
#Problem 3
...
plot_interpolations(df = df, col1 = df$min_day, Title = "Day",
                    Big_Title = "Coldest Day of Year",type = 3)

plot_interpolations(df = df, col1 = df$max_day, type = 3, Title = "Day",
                    Big_Title = "Hottest Day of Year")
...
plot_interpolations(df = preds, col1 = preds$AVERAGE, type = 2, 
                    Big_Title = "Coldest Day of Year Interpolation",
...
plot_interpolations(df = preds, col1 = preds$AVERAGE, type = 2, 
                    Title = "Day",
                    Big_Title = "Hottest Day of Year Interpolation")
```
...
plot(1:365,df[,1],type = "l",col = 1, ylim = c(-10,30), 
     xlab = "Day", ylab = "Temperature", main = "Yearly Cycle")
...
plot_interpolations(df = df, col1 = df$trend, type = 3,col2 = df$pvalue, Title = "Trend", size_name = "p_value", Big_Title = "Temperature Trend")
...
plot_interpolations(df = preds, col1 = preds$AVERAGE, type = 2, 
                    Title = "Trend",Big_Title = "Temperature Trend")
```
